...
/Applications/Unity/Unity.app/Contents/MacOS/Unity -batchmode -projectPath $PWD -executeMethod AssetDatabase.Refresh 

# After refresh the current state of the code is reflected in the tests
/Applications/Unity/Unity.app/Contents/MacOS/Unity -batchmode -projectPath $PWD -executeMethod UnityTest.UnitTestView.RunAllTestsBatch
